...
namespace CrimeGameBlazor_DataAccess.Migrations
{
    ...
    [Migration("20230105145329_MadeNameOfGangsterUnique")]
    partial class MadeNameOfGangsterUnique
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CrimeGameBlazor_DataAccess.ApplicationUser", b =>
                {
                    ...
                    b.HasIndex("GangsterId")
                        .IsUnique()
                        .HasFilter("[GangsterId] IS NOT NULL");
            ...
            modelBuilder.Entity("CrimeGameBlazor_DataAccess.Gangster", b =>
                {
                    b.HasOne("CrimeGameBlazor_DataAccess.ApplicationUser", null)
                        .WithMany("Gangsters")
            ...
            modelBuilder.Entity("CrimeGameBlazor_DataAccess.ApplicationUser", b =>
                {
                    b.HasOne("CrimeGameBlazor_DataAccess.Gangster", "CurrentGangster")
                        .WithOne("User")
                        .HasForeignKey("CrimeGameBlazor_DataAccess.ApplicationUser", "GangsterId")
                        .OnDelete(DeleteBehavior.NoAction);
